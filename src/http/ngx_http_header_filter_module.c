...
static u_char ngx_http_server_string[] = "Server: foo" CRLF;
static u_char ngx_http_server_full_string[] = "Server: foo" CRLF;
static u_char ngx_http_server_build_string[] = "Server: foo " CRLF;
